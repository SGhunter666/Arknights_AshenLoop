...
var ui_text := {
	...
	"main.save_slot": {"zh": "存档1 | %s\n第 %d 层  %d/%d", "en": "Save 1 | %s\nFloor %d  %d/%d"},
	...
	"single.overwrite_save_title": {"zh": "覆盖当前存档", "en": "Overwrite Current Save"},
	"single.overwrite_save_body": {"zh": "当前还有 %s 的未完成行动：第 %d 层，生命 %d/%d，金币 %d。\n\n如果现在开始 %s 的新行动，就会放弃这份进度。是否继续？", "en": "There is still an unfinished run for %s: Floor %d, HP %d/%d, Gold %d.\n\nStarting a new run with %s will abandon that progress. Continue?"},
	"single.overwrite_save_confirm": {"zh": "放弃并开始", "en": "Abandon and Start"},
	"single.overwrite_save_cancel": {"zh": "取消", "en": "Cancel"},
	...
	"single.missing_amiya": {"zh": "缺少阿米娅角色资源。", "en": "Missing character resource: amiya.tres"},
	...
	"single.amiya_header": {"zh": "阿米娅 | 罗德岛领袖", "en": "Amiya | Leader of Rhodes Island"},
	...
	"codex.stats_body": {"zh": "查看各名角色的战斗定位、卡池方向与行动统计。", "en": "Review operator roles, card pool directions, and run statistics."},
	...
	"codex.detail_modules": {"zh": "这里会记录获得过的模块、它们的效果，以及哪些模块更适合不同角色当前的构筑。", "en": "This section tracks found modules, their effects, and which builds they best support across operators."},
	...
	"codex.detail_stats": {"zh": "角色数据会集中展示各名角色的定位说明、卡池规模和当前行动概况。", "en": "Operator data highlights each operator's role, card pool size, and current run overview."},
	...
	"codex.stats_summary_title": {"zh": "行动总览", "en": "Operation Summary"},
	"codex.stats_summary_body": {"zh": "这里集中记录全局行动统计、当前未完成行动与本局启用中的调律。", "en": "This section gathers global run statistics, the current active run, and the tunes active in the ongoing operation."},
	"codex.stats_profile_title": {"zh": "作战总览", "en": "Run Overview"},
	"codex.stats_operator_summary_title": {"zh": "角色战绩", "en": "Operator Record"},
	"codex.history_title": {"zh": "历史记录", "en": "History"},
	"codex.glossary_title": {"zh": "术语说明", "en": "Glossary"},
	"codex.glossary_general_title": {"zh": "通用战斗术语", "en": "Core Combat Terms"},
	"codex.glossary_general_body": {"zh": "所有角色都会反复用到的基础规则、状态和结算术语。", "en": "Foundational rules, status effects, and resolution terms used across every operator."},
	"codex.glossary_amiya_title": {"zh": "阿米娅丨术式档案", "en": "Amiya | Arts Archive"},
	"codex.glossary_amiya_body": {"zh": "阿米娅的构筑围绕术式、共振、支援与意志展开，这一组术语会在她的牌组里高频出现。", "en": "Amiya's build revolves around Arts, Resonance, Support, and Will. These are the terms that show up most often in her deck."},
	"codex.glossary_exusiai_title": {"zh": "能天使丨火力档案", "en": "Exusiai | Firepower Archive"},
	"codex.glossary_exusiai_body": {"zh": "能天使的卡组偏向射击、弹药与节奏爆发。这一组术语会决定她每回合能不能把火力拉满。", "en": "Exusiai's deck leans into shots, ammo, and tempo bursts. These are the terms that determine whether she can fully ramp her firepower each turn."},
	"codex.glossary_kaltsit_title": {"zh": "凯尔希丨Mon3tr医疗档案", "en": "Kal'tsit | Mon3tr Medical Archive"},
	"codex.glossary_kaltsit_body": {"zh": "凯尔希围绕医疗、修复、指令与 Mon3tr 完整性运转。她的重点不是快，而是把 Mon3tr 修到临界点后进入“指令：融毁”。", "en": "Kal'tsit revolves around Medical cards, Repair, Commands, and Mon3tr Integrity. Her focus is not speed, but stabilizing Mon3tr until Command: Meltdown opens."},
	"codex.term_mon3tr_title": {"zh": "Mon3tr", "en": "Mon3tr"},
	"codex.term_mon3tr_body": {"zh": "Mon3tr 是凯尔希的常驻召唤物。指令牌通常会让 Mon3tr 攻击，伤害会受到完整性与融毁状态影响。", "en": "Mon3tr is Kal'tsit's persistent summon. Command cards usually make Mon3tr attack, and its damage is affected by Integrity and Meltdown."},
	"codex.term_medical_title": {"zh": "医疗", "en": "Medical"},
	"codex.term_medical_body": {"zh": "医疗牌主要治疗凯尔希、提供护盾，或修复 Mon3tr。凯尔希的许多联动会检查本回合是否使用过医疗牌。", "en": "Medical cards heal Kal'tsit, grant Block, or repair Mon3tr. Many Kal'tsit synergies check whether a Medical card was played this turn."},
	"codex.term_integrity_title": {"zh": "完整性", "en": "Integrity"},
	"codex.term_integrity_body": {"zh": "完整性是 Mon3tr 的结构值。普通上限为 10，战斗开始为 3/10；从第二个凯尔希回合开始，每回合自动修复 1。低于 3 时 Mon3tr 进入临界状态，伤害降低。", "en": "Integrity is Mon3tr's structural value. It starts combat at 3/10; from Kal'tsit's second turn onward, it repairs 1 at the start of each turn. At 1 or 2 Integrity, Mon3tr becomes Critical and deals less damage."},
	"codex.term_repair_title": {"zh": "修复", "en": "Repair"},
	"codex.term_repair_body": {"zh": "修复会恢复 Mon3tr 的完整性。达到当前上限时会自动启动“指令：融毁”，所以修复牌既是防御手段，也是凯尔希的爆发启动器。", "en": "Repair restores Mon3tr Integrity. Reaching the current maximum automatically starts Command: Meltdown, so Repair is both defense and Kal'tsit's burst starter."},
	"codex.term_meltdown_title": {"zh": "指令：融毁", "en": "Command: Meltdown"},
	"codex.term_meltdown_body": {"zh": "当 Mon3tr 达到当前完整性上限时自动进入融毁。融毁中凯尔希攻击与 Mon3tr 伤害 +50%，Mon3tr 伤害无视敌方护盾；若完整性低于 5，则退出融毁。", "en": "When Mon3tr reaches max Integrity, it automatically enters Meltdown. Kal'tsit attacks and Mon3tr damage gain +50%, Mon3tr ignores enemy Block, and Meltdown ends below 5 Integrity."},
	"codex.term_protocol_title": {"zh": "协议", "en": "Protocol"},
	"codex.term_protocol_body": {"zh": "协议牌多为长期能力，会强化医疗、修复、指令或融毁循环。它们是凯尔希后期构筑的骨架。", "en": "Protocol cards are mostly long-term Powers that improve Medical, Repair, Command, or Meltdown loops. They form the backbone of late Kal'tsit builds."},
	"codex.term_scalpel_title": {"zh": "手术切击", "en": "Scalpel"},
	"codex.term_scalpel_body": {"zh": "手术切击代表凯尔希自己的攻击牌。融毁中，凯尔希攻击牌伤害会提高 50%。", "en": "Scalpel marks Kal'tsit's own attack cards. During Meltdown, Kal'tsit Attack card damage is increased by 50%."},
	...
	"codex.stats_active_operator": {"zh": "当前行动角色：%s", "en": "Active Operator: %s"},
	...
	"codex.operator_card_count": {"zh": "专属卡牌：%d 张", "en": "Signature Cards: %d"},
	"codex.operator_module_count": {"zh": "关联模块：%d 个", "en": "Related Modules: %d"},
	"codex.operator_charm_count": {"zh": "关联护符：%d 个", "en": "Related Charms: %d"},
	...
	"codex.term_will_title": {"zh": "意志", "en": "Will"},
	"codex.term_will_body": {"zh": "阿米娅的专属资源，上限 10。它不会自动让所有牌统一增伤，但会明确强化部分爆发术式：`精神校准` 与 `纪律便签` 各给 +1 意志，`燃烧意志` 给 +3 意志；`回响导流` 会额外获得「每 1 点意志 +1 伤害」，最多 +6；`共振爆发` 在意志达到 4 以上时额外 +4 伤害。意志越高，风险也越高，因为它经常和自伤、节奏损失或过载打法绑在一起。", "en": "Amiya's exclusive resource, capped at 10. It does not passively boost every card, but it clearly empowers some burst Arts: `Mind Alignment` and `Discipline Note` each grant +1 Will, `Burn Will` grants +3, `Echo Conduit` gains +1 damage per Will up to +6, and `Resonance Burst` gains +4 damage at 4+ Will. High Will also carries risk because it is often tied to self-damage, tempo loss, or overload lines."},
	"codex.term_arts_title": {"zh": "术式", "en": "Arts"},
	"codex.term_arts_body": {"zh": "带有术式标签的牌会吃到阿米娅最核心的联动，也是她主要的伤害来源。当前原型里，阿米娅每回合第一次打出支援牌后，下一张术式牌固定 +2 伤害；如果带着 `灰烬丝线` 模块并且你刚刚自伤过，下一张术式还会再额外 +3。", "en": "Cards with the Arts tag benefit from Amiya's most important synergy and serve as her main damage source. In the current prototype, after Amiya plays her first Support each turn, her next Arts card gets a flat +2 damage. With `Ashen Thread`, the next Arts card after self-damage gains an additional +3."},
	"codex.term_support_title": {"zh": "支援", "en": "Support"},
	"codex.term_support_body": {"zh": "支援牌偏向抽牌、返还能量、调整节奏或找回关键牌。数值上最关键的是：阿米娅每回合第一次打出支援牌后，下一张术式固定 +2 伤害；如果装着 `战场指令徽章`，这第一次支援还会额外返还 1 点能量。", "en": "Support cards focus on draw, energy refunds, tempo control, or retrieving key tools. Numerically, the big payoff is this: after Amiya plays her first Support each turn, her next Arts card gets a flat +2 damage; with `Field Command Badge`, that first Support also refunds 1 extra Energy."},
	"codex.term_command_title": {"zh": "指挥（指令）", "en": "Command"},
	"codex.term_command_body": {"zh": "指挥标签代表这张牌会直接改动你本回合的出牌顺序、收益触发或支援节奏。它通常不会自己造成高伤害，但会让后面的牌更顺：像返还能量、让下一张牌减费，或把支援收益提前兑现。", "en": "The Command tag marks cards that directly alter sequencing, trigger order, or support tempo in the current turn. They usually do not hit hard on their own, but they make the rest of the turn cleaner through refunds, discounts, or early payoff windows."},
	"codex.term_tactic_title": {"zh": "战术（战术）", "en": "Tactic"},
	"codex.term_tactic_body": {"zh": "战术牌偏重调度而不是硬打输出。它们常见的工作是检索、抽牌、换牌、调整下一张牌的费用或给后续行动先挂好条件。简单说，战术牌是用来把这一回合排顺的。", "en": "Tactic cards prioritize routing over raw damage. They often tutor, draw, cycle cards, adjust costs, or set up the next play before it resolves. In short, tactic cards are used to make the turn line up correctly."},
	"codex.term_resonance_title": {"zh": "共振", "en": "Resonance"},
	...
	"codex.term_echo_title": {"zh": "回响", "en": "Echo"},
	"codex.term_echo_body": {"zh": "回响代表「下一张术式会额外触发一次部分效果」。当前原型里最常见的是 50%%回响，也就是再触发一次基础效果的 50%%。`回响格` 会给予 50%%回响；`七重回响` 会给接下来 2 张术式牌 50%%回响；如果你有 `镜波`，带着 回响 时还会再额外重复一次基础伤害。", "en": "Echo means your next Arts card repeats part of its effect. The most common form in the prototype is 50%% Echo, which repeats 50%% of the card's base effect. `Echo Lattice` grants 50%% Echo, `Sevenfold Echo` gives the next 2 Arts cards 50%% Echo, and `Mirrored Wave` repeats its base damage again if Echo is active."},
	"codex.term_channel_title": {"zh": "引导", "en": "Channel"},
	"codex.term_channel_body": {"zh": "引导牌不会把主要收益立刻结算，而是先把效果存起来，等到下回合开始或回合结束时再触发。它们适合提前铺垫爆发、补弹或节奏转折，但也意味着你要先撑过这一拍。", "en": "Channel cards do not resolve their main payoff immediately. Instead, they store the effect and trigger it later, usually at the next turn start or the end of the turn. They are great for preloading bursts, reloads, or tempo turns, but they ask you to survive the delay first."},
	"codex.term_block_title": {"zh": "护盾", "en": "Block"},
	...
	"codex.term_heal_title": {"zh": "回复", "en": "Heal"},
	"codex.term_heal_body": {"zh": "回复会直接把已经损失的生命补回来，但不会超过最大生命值。它和护盾不同，属于事后修复而不是提前挡伤。阿米娅这边比较少见，更多会出现在支援线或后续角色的牌组里。", "en": "Healing restores missing HP directly, but never beyond max HP. Unlike Block, it repairs damage after the fact instead of preventing it up front. It is rarer in Amiya's pool and more common in support lines or later operators."},
	"codex.term_weak_title": {"zh": "虚弱", "en": "Weak"},
	...
	"codex.term_vulnerable_title": {"zh": "易伤", "en": "Vulnerable"},
	...
	"codex.term_strength_title": {"zh": "力量", "en": "Strength"},
	...
	"codex.term_curse_title": {"zh": "诅咒", "en": "Curse"},
	"codex.term_curse_body": {"zh": "诅咒牌一般帮不上忙，只会塞进牌堆拖慢节奏，严重时还会直接带来惩罚。当前原型里：`迟疑` 若回合结束还在手里会失去 1 点意志；`恐慌静电` 抽到时会让你本回合第一张牌费用 +1；`爆破倒计时` 若回合结束还留在手里，会直接受到 8 点伤害。", "en": "Curse cards usually do not help and only clog the deck, slowing your tempo or directly causing penalties. In the current prototype: `Hesitation` makes you lose 1 Will if it remains in hand at end of turn, `Panic Static` makes your first card cost +1 when drawn, and `Blast Countdown` deals 8 damage if it is still in hand at end of turn."},
	"codex.term_status_title": {"zh": "状态牌", "en": "Status Cards"},
	"codex.term_status_body": {"zh": "状态牌不是诅咒，但通常也不会像正常牌那样稳定赚钱。它们往往代表临时污染、过载副产物或战场杂质。有些状态牌会拖节奏，有些则能在特定构筑里被当成资源反过来利用。", "en": "Status cards are not curses, but they also do not behave like normal value cards. They usually represent temporary contamination, overload byproducts, or battlefield clutter. Some only slow you down, while others can be exploited as resources in the right build."},
	"codex.term_rescue_title": {"zh": "救援", "en": "Rescue"},
	"codex.term_rescue_body": {"zh": "救援类牌和事件代表阿米娅把资源分出去救人。它们通常不会立刻打出最高伤害，但会换来金币、剧情标记或更好的长期收益。比如 `救援走廊` 当前就是 1 费，给 6 点护盾并立即获得 10 金币。", "en": "Rescue cards and events represent Amiya diverting resources to save people. They usually do not create the biggest immediate damage, but they can pay off through gold, story flags, or stronger long-term rewards. For example, `Rescue Corridor` currently costs 1, grants 6 Block, and immediately gives 10 Gold."},
	"codex.term_overload_title": {"zh": "过载", "en": "Overload"},
	"codex.term_overload_body": {"zh": "过载不是单独一个状态图标，而是一种高风险打法。你会用自伤、少抽牌或节奏损失，去换更高的术式爆发。当前原型里最直接的例子是：`燃烧意志` 会失去 4 点生命换 3 点意志，`术式超频` 会先打出 16 点术式伤害，再失去 3 点生命。", "en": "Overload is not a single status icon but a high-risk play pattern. You trade self-damage, reduced draw, or tempo loss for stronger Arts bursts. In the current prototype, the clearest examples are `Burn Will`, which trades 4 HP for 3 Will, and `Overclock Arts`, which deals 16 Arts damage and then costs 3 HP."},
	"codex.term_slow_title": {"zh": "迟滞", "en": "Slow"},
	...
	"codex.term_exhaust_title": {"zh": "消耗", "en": "Exhaust"},
	...
	"codex.term_ethereal_title": {"zh": "飘忽", "en": "Ethereal"},
	...
	"codex.term_multihit_title": {"zh": "连击", "en": "Multi-hit"},
	"codex.term_multihit_body": {"zh": "连击代表一张牌会分成多段伤害结算。它更适合打虫群、削护盾和吃多次命中联动；如果目标带着力量、标记或其他逐段结算的修正，连击通常会把这些收益放大得更明显。", "en": "Multi-hit means a card resolves its damage in several separate hits. It is strong against swarms, shields, and on-hit synergies. When strength, mark, or similar per-hit bonuses are active, multi-hit cards magnify those benefits more clearly."},
	"codex.term_aoe_title": {"zh": "范围伤害", "en": "Area Damage"},
	...
	"codex.term_energy_title": {"zh": "能量", "en": "Energy"},
	"codex.term_energy_body": {"zh": "每回合打牌都要花能量。所有角色默认基础能量都是 3；能天使不再天生高能量，而是通过准备 爆发，在下一回合获得 +2 能量和 +2 抽牌来打出连射高潮。如果带着 `备用电池`，第一回合会额外 +1 能量。", "en": "Playing cards costs Energy. All characters now start each turn with 3 base Energy. Exusiai no longer has innate extra Energy; instead, preparing Burst grants +2 Energy and +2 draw on the next turn for her firing window. `Reserve Battery` adds +1 Energy on turn one."},
	"codex.term_strain_title": {"zh": "精神负荷", "en": "Mental Strain"},
	"codex.term_strain_body": {"zh": "精神负荷不是单独的状态条，而是你为高爆发付出的实际代价。当前原型里它主要表现为 3 种东西：1. 直接掉生命，例如 `燃烧意志` -4 生命、`术式超频` -3 生命、W 规则下每打出第 3 张牌自伤 2。2. 失去意志，例如 `迟疑` 留手回合结束 -1 意志。3. 节奏惩罚，例如 `恐慌静电` 让第一张牌费用 +1。", "en": "Mental Strain is not a separate meter but the real cost you pay for high burst turns. In the current prototype it appears in three main forms: 1. direct HP loss, such as `Burn Will` for -4 HP, `Overclock Arts` for -3 HP, and W's rule dealing 2 self-damage every third card; 2. Will loss, such as `Hesitation` causing -1 Will if left in hand; and 3. tempo penalties, such as `Panic Static` making your first card cost +1."},
	"codex.term_shot_title": {"zh": "射击", "en": "Shot"},
	"codex.term_shot_body": {"zh": "射击标签是能天使的主输出轴。射击 牌会吃弹药、标记、爆发窗口和射击专属模块。能天使平时也是 3 能量、抽 5 张；她的强回合来自提前准备 爆发，下一回合用 +2 能量、+2 抽牌把 射击 连成一整轮。爆发 中 射击 额外 +1 伤害；本回合第 2 张 射击 抽 1，第 3 张 射击 返还 1 弹药 并追加 3 点伤害，这些节拍每回合各触发一次。", "en": "The Shot tag is Exusiai's main damage tag. Shot cards benefit from Ammo, Mark, Burst, and shot-specific modules. Exusiai normally has 3 Energy and draws 5; her power turn comes from preparing Burst, then using +2 Energy and +2 draw next turn to chain Shots. During Burst, Shots gain +1 damage; the second Shot draws 1, and the third Shot refunds 1 Ammo and deals 3 extra damage. Each cadence trigger happens once per turn."},
	"codex.term_ammo_title": {"zh": "弹药", "en": "Ammo"},
	"codex.term_ammo_body": {"zh": "弹药是能天使的专属资源。她开局会装满弹药，很多 射击 牌会消耗 弹药 才能结算完整伤害；弹药不够时，多段射击和爆发牌通常会断档。装填、补弹、爆发节拍和部分模块会把 弹药 补回来，所以能天使的关键是先铺补弹，再抓住爆发回合连射。", "en": "Ammo is Exusiai's exclusive resource. She starts combat loaded, and many Shot cards need Ammo to resolve their full output. Reloads, refills, Burst cadence, and modules restore Ammo, so the key is preparing reloads before chaining a Burst turn."},
	"codex.term_reload_title": {"zh": "装填", "en": "Reload"},
	...
	"codex.term_mark_title": {"zh": "标记", "en": "Mark"},
	"codex.term_mark_body": {"zh": "标记是挂在敌人身上的锁定层数。标记 本身不是普通易伤，而是能天使用来指定收割目标的资源：部分 射击 会对带 标记 的敌人追加伤害，终结牌会把 标记 整批兑现。默认敌人回合结束后会掉 1 层，所以要在衰减前集中火力。", "en": "Mark is a stack of target lock on enemies. It is not ordinary Vulnerable; it is Exusiai's targeting resource. Some Shots gain extra damage against marked enemies, and finishers cash Mark out. Enemies usually lose 1 Mark at the end of their turn."},
	"codex.term_burst_title": {"zh": "爆发", "en": "Burst"},
	"codex.term_burst_body": {"zh": "爆发回合是能天使的下一回合强化连射窗口。打出 爆发 牌时不会当场爆发，而是获得“备”：下个玩家回合开始进入 爆发，能量 +2、抽牌 +2。进入 爆发 后，射击 +1 伤害；第 2 张 射击 抽 1，第 3 张 射击 返还 1 弹药 并追加 3 点伤害。它不是常驻增益，而是先铺 弹药 / 标记 / 装填，再用下一回合 爆发 一口气清场或点杀。", "en": "Burst is Exusiai's next-turn empowered firing window. Playing a Burst card does not activate immediately; it gives Prepare, then at the start of your next player turn Burst activates with +2 Energy and +2 draw. During Burst, Shots gain +1 damage; the second Shot draws 1, and the third Shot refunds 1 Ammo and deals 3 extra damage."},
	"codex.term_tempo_title": {"zh": "节奏", "en": "Tempo"},
	...
	"codex.term_finisher_title": {"zh": "终结", "en": "Finisher"},
	...
	"map.sidebar_preview_default": {"zh": "悬停节点，先看检定、敌人和后续路线。", "en": "Hover a node to preview its check, enemies, and branching route."},
	"map.sidebar_preview_route": {"zh": "后续：%s", "en": "Route: %s"},
	"map.sidebar_preview_tests": {"zh": "检定：%s", "en": "Check: %s"},
	...
	"map.sidebar_reward_boss": {"zh": "首领结算与推进奖励", "en": "Boss payout and progression reward"},
	"map.sidebar_reward_shop": {"zh": "买牌并修整构筑", "en": "Buy cards and repair your build"},
	"map.sidebar_reward_event": {"zh": "剧情抉择与长期变化", "en": "Story choices and long-term changes"},
	"map.sidebar_reward_rest": {"zh": "回血、升级与调律", "en": "Heal, upgrade, and tune"},
	...
	"battle.target_hint_body": {"zh": "点击敌人确认。右键或取消键取消。当前锁定：%s", "en": "Click an enemy to confirm. Right-click or Esc to cancel. Current lock: %s"},
	...
	"battle.float_radiance_gain": {"zh": "光耀 +%d", "en": "Radiance +%d"},
	"battle.float_counter_gain": {"zh": "反击 +%d", "en": "Counter +%d"},
	"battle.float_next_damage_reduction": {"zh": "减伤 +%d", "en": "Reduce +%d"},
	...
	"battle.float_resonance_burst": {"zh": "引爆 ×%d", "en": "Burst x%d"},
	...
	"battle.status_ammo": {"zh": "弹药 %d/%d\n射击 牌会直接消耗弹药。能天使默认 3 能量、抽 5 张，手牌上限为 10；先准备 弹药 / 装填 / 标记，再用 爆发 的下一回合 +2 能量、+2 抽牌打连射。", "en": "Ammo %d/%d\nShot cards spend Ammo. Exusiai defaults to 3 Energy and draws 5, with a hand limit of 10. Prepare Ammo, Reload, and Mark before using next-turn Burst for +2 Energy and +2 draw."},
	...
	"battle.status_mark": {"zh": "标记 %d\n标记 是能天使用来锁定收割目标的层数资源。带 标记 的敌人会吃到更多 射击 收益，终结牌可把 标记 整批转成伤害。若没有锁定效果，敌人回合结束后通常会掉 1 层。", "en": "Mark %d\nMark is Exusiai's targeting resource. Marked enemies give better Shot payoffs, and finishers can cash Mark out for damage. Without a lock effect, enemies usually lose 1 Mark at the end of their turn."},
	"battle.status_burst": {"zh": "爆发回合\n准备完成后进入的强化连射窗口。本回合已经获得 +2 能量、+2 抽牌；射击 额外 +1 伤害；第 2 张 射击 抽 1，第 3 张 射击 返还 1 弹药 并追加 3 点伤害，各触发一次。", "en": "Burst turn\nThe prepared firing window is active. This turn already gained +2 Energy and +2 draw. Shots gain +1 damage; the 2nd Shot draws 1, and the 3rd Shot refunds 1 Ammo and deals 3 extra damage, once each."},
	"battle.status_burst_prepared": {"zh": "爆发 已准备\n下个玩家回合开始时进入爆发回合：能量 +2，抽牌 +2，并启用 射击 连射节拍。重复准备只会刷新这个下回合爆发，不会叠加多次。", "en": "Burst prepared\nAt the start of your next player turn, enter Burst: +2 Energy, +2 draw, and Shot cadence enabled. Preparing again only refreshes next-turn Burst; it does not stack multiple times."},
	"battle.status_radiance": {"zh": "光耀 %d/5\n临光的战斗内层数资源。每层让反击伤害 +1；当前让护盾 +%d、治疗 +%d。", "en": "Radiance %d/5\nNearl's battle-long layered resource. Each stack adds +1 Counter damage. Current bonuses: Block +%d, Heal +%d."},
	"battle.status_counter": {"zh": "反击 %d\n敌人主动攻击临光时，若临光在受击前有护盾，则每个敌人每回合最多触发一次反击。当前光耀 +%d，预计反击伤害 %d。", "en": "Counter %d\nWhen an enemy actively attacks Nearl, if she had Block before the hit, each enemy can trigger Counter once per turn. Current Radiance +%d, expected Counter damage %d."},
	"battle.status_next_damage_reduction": {"zh": "下一次受击减伤 %d\n会在下一次敌方伤害结算前抵消等量伤害。", "en": "Next hit reduction %d\nPrevents this much damage before the next enemy damage is resolved."},
	"battle.log.radiance_gain": {"zh": "光耀 +%d（%d/5）。", "en": "Radiance +%d (%d/5)."},
	"battle.log.counter_gain": {"zh": "反击 +%d（当前 %d）。", "en": "Counter +%d (now %d)."},
	"battle.log.next_damage_reduction": {"zh": "下一次受击减伤 +%d。", "en": "Next hit reduction +%d."},
	...
	"rest.service_rewire_arts": {"zh": "重构：每回合第一张 术式 +2 伤害", "en": "Rewire: first Arts each turn deals +2 damage"},
	"rest.service_rewire_support": {"zh": "重构：每战第一次 支援 抽 2", "en": "Rewire: first Support each battle draws 2"},
	"rest.service_rewire_overload": {"zh": "重构：过载 结算伤害 -1", "en": "Rewire: Overload tick damage -1"},
	"rest.service_equip_charm": {"zh": "补入护符：获得一个未拥有的 护符", "en": "Equip Charm: gain an unowned Charm"},
	...
	"rest.done_rewire_arts": {"zh": "已选择临时战术：每回合第一张 术式 +2 伤害。", "en": "Tactical rewire applied: first Arts each turn deals +2 damage."},
	"rest.done_rewire_support": {"zh": "已选择临时战术：每战第一次 支援 抽 2。", "en": "Tactical rewire applied: first Support each battle draws 2."},
	"rest.done_rewire_overload": {"zh": "已选择临时战术：过载 结算伤害 -1。", "en": "Tactical rewire applied: Overload tick damage -1."},
	"rest.done_equip_charm": {"zh": "已装备 护符：%s。", "en": "Charm equipped: %s."},
	"rest.done_equip_charm_full": {"zh": "所有 护符 都已经拥有。", "en": "All Charms already owned."},
...
var card_text := {
	...
	"echo_lattice": {"zh_name": "回响格", "zh_desc": "获得 回响：下一张术式牌重复 50% 基础效果。"},
	...
	"ace_last_stand": {"zh_name": "王牌·最后防线", "zh_desc": "获得 15 点护盾；若生命值不高于 30%，额外获得 2 点能量。"},
	...
	"mirrored_wave": {"zh_name": "镜波", "zh_desc": "造成 10 点术式伤害；若你拥有 回响，再额外重复一次基础伤害。"},
	...
	"feedback_loop": {"zh_name": "反馈回路", "zh_desc": "若目标已有共振，获得 回响，并再对目标施加 2 层共振。"},
	...
	"sevenfold_echo": {"zh_name": "七重回响", "zh_desc": "接下来 2 张术式牌获得 回响 50%。"},
	...
	"absolute_resonance": {"zh_name": "绝对共振", "zh_desc": "能力。每当你消耗共振，获得 回响 50%。"},
	...
	"echo_reserve": {"zh_name": "回响储备", "zh_desc": "引导：下回合获得 回响 50%。"},
	...
	"absolute_resonance_plus": {"zh_name": "绝对共振+", "zh_desc": "能力。每当你消耗共振，获得 回响 50%。（费用 1）"},
	"ace_last_stand_plus": {"zh_name": "王牌·最后防线+", "zh_desc": "获得 20 点护盾；若生命值不高于 30%，额外获得 2 点能量。"},
	...
	"echo_lattice_plus": {"zh_name": "回响格+", "zh_desc": "获得 回响：下一张术式牌重复 75% 基础效果。"},
	"echo_reserve_plus": {"zh_name": "回响储备+", "zh_desc": "引导：下回合获得 回响 75%。"},
	...
	"feedback_loop_plus": {"zh_name": "反馈回路+", "zh_desc": "若目标已有共振，获得 回响，并再对目标施加 3 层共振。"},
	...
	"mirrored_wave_plus": {"zh_name": "镜波+", "zh_desc": "造成 13 点术式伤害；若你拥有 回响，再额外造成 13 点。"},
	...
	"sevenfold_echo_plus": {"zh_name": "七重回响+", "zh_desc": "接下来 3 张术式牌获得 回响 50%。"},
...
var module_text := {
	...
	"ashen_halo": {"zh_name": "灰烬光环", "zh_desc": "每场战斗第一次进入 过载 时，不受下一次 过载 结算惩罚，并抽 2。"},
	"crown_of_responsibility": {"zh_name": "责任之冠", "zh_desc": "意志 上限 +3。回合结束失去 1 点生命。"},
	"dobermann_manual": {"zh_name": "杜宾训练手册", "zh_desc": "基础牌额外获得 1 点数值。"},
	"echo_pin": {"zh_name": "回响别针", "zh_desc": "每场战斗第一次获得 回响 时，再抽 1。"},
	...
	"kaltsits_log": {"zh_name": "凯尔希记录", "zh_desc": "每场战斗第一次使用 引导 牌时，立即抽 2。"},
	"nearl_crest": {"zh_name": "临光护徽", "zh_desc": "每场战斗的第一回合获得 8 点护盾；获得护盾时额外 +20%。"},
	"originium_fragment": {"zh_name": "源石碎片", "zh_desc": "你每回合第一张 术式 牌 +2 伤害。"},
	"pain_converter": {"zh_name": "痛觉换流器", "zh_desc": "每次失去 生命 后，下张 术式 牌 +1 伤害，本回合累计。"},
	"recorder_of_resolve": {"zh_name": "意志记录仪", "zh_desc": "战斗开始时获得 1 意志。"},
	"reserve_battery": {"zh_name": "备用电池", "zh_desc": "每场战斗第一回合额外获得 1 点能量。"},
	"resonance_anchor": {"zh_name": "共振锚", "zh_desc": "敌人的 共振 不会在敌人回合结束时减少。"},
	"resonance_prism": {"zh_name": "共振棱镜", "zh_desc": "每次你消耗 共振，随机 1 张手牌费用 -1。"},
	...
	"support_grid": {"zh_name": "支援阵列", "zh_desc": "你每回合第一张 支援 牌触发两次基础效果。"},
...
var intent_labels := {
	...
	"Double Slash 4x2": {"zh": "双重斩击 4×2", "en": "Double Slash 4x2"},
	...
	"Drone Burst 3x3": {"zh": "无人机连射 3×3", "en": "Drone Burst 3x3"},
...
var exusiai_event_text := {
	...
	"originium_echo_corridor": {
		"zh_title": "回声靶场",
		"zh_body": "长廊会把每一声枪响反弹回来。源石嵌在墙体里，让回声拖出奇怪的尾音。\n\n能天使很快就找到了节奏：这里可以把一张牌调成更适合连锁，也可以压低费用，或者取走让标记更难消散的锁定锚点。"
	},
	...
	"doctor_question": {
		"zh_title": "博士的路线提问",
		"zh_body": "博士没有直接下命令，只问能天使：下一步，你想把火力用来保护什么？\n\n这不是哲学题。你的回答会影响后续奖励的倾向：更偏救援支援，更偏效率爆发，或者更偏高风险承担。"
	},
	"doctor_reflection": {
		"zh_title": "博士的火力复盘",
		"zh_body": "博士之前的回答被记录在行动日志里。现在，同样的问题变成了一个具体战术选择：一支小队被伏击，需要能天使立刻决定支援方式。\n\n如果选择和之前路线一致，收益会更强；如果选择不同，也许能把当前局面拉回更适合的方向。"
	},
...
var exusiai_event_result_text := {
	...
	"牌组里多了一条共振线索。": "牌组里多了一条可用的标记线索。",
	"你把术式压缩得更轻。": "你把开火路线压缩得更轻。",
	"共振锚会让敌人的共振更难消散。": "锁定锚点会让敌人的标记更难消散。",
	"后续奖励会更偏向透支与意志混合。": "后续奖励会更偏向高风险火力与爆发节奏。",
	"部署图被还原了七成。下一场战斗你会带着更清晰的意图入场，开局获得 3 点意志。": "部署图被还原了七成。下一场战斗你会带着更清晰的火力节奏入场，开局获得 2 点 弹药。",
	"你带走了两段能用的共振术式。": "你带走了两段能用的标记射击方案。"
}
...
var character_profiles := {
	...
	"kaltsit": {
		"zh_name": "凯尔希",
		"en_name": "Kal'tsit",
		"zh_header": "凯尔希 | Mon3tr",
		"en_header": "Kal'tsit | Mon3tr Medical Command",
		"zh_stats": "生命 72/72    起始能量 4    每回合抽牌 4\n核心倾向：医疗修复 / Mon3tr 指令",
		"en_stats": "HP 72/72    Starting Energy 4    Draw 4    Core Focus: Medical Repair / Mon3tr Command",
		"zh_intro": "凯尔希不靠高速连射，也不靠单次术式爆发。她会在战斗开始时带着 Mon3tr 入场，用医疗牌维持自己，用修复牌维持 Mon3tr，再用指令牌让 Mon3tr 撕开敌人的防线。",
		"en_intro": "Kal'tsit does not rely on rapid volleys or single Arts bursts. She enters combat with Mon3tr, sustains herself through Medical cards, repairs Mon3tr, and uses Commands to break enemy lines.",
		"zh_mechanic": "特有机制：Mon3tr 完整性 / 指令：融毁\nMon3tr 战斗开始为 3/10 完整性；从第二个凯尔希回合开始，每回合自动修复 1。当完整性达到上限时进入“指令：融毁”：凯尔希攻击和 Mon3tr 伤害 +50%，Mon3tr 伤害无视敌方护盾。完整性低于 5 时退出融毁。",
		"en_mechanic": "Signature System: Mon3tr Integrity / Command: Meltdown\nMon3tr starts each combat at 3/10 Integrity; from Kal'tsit's second turn onward, it repairs 1 every turn. At max Integrity, Command: Meltdown activates: Kal'tsit attacks and Mon3tr damage gain +50%, and Mon3tr ignores enemy Block. Meltdown ends below 5 Integrity."
	}
}
...
func text(key: String, format_args: Array = []) -> String:
	...
	var resolved: String = raw % format_args if not format_args.is_empty() else raw
