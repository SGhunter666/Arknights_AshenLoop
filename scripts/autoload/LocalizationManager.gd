...
var ui_text := {
	...
	"codex.term_command_title": {"zh": "指挥（Command）", "en": "Command"},
	...
	"codex.term_tactic_title": {"zh": "战术（Tactic）", "en": "Tactic"},
	...
	"codex.term_channel_title": {"zh": "引导（Channel）", "en": "Channel"},
	...
	"codex.term_heal_title": {"zh": "回复（Heal）", "en": "Heal"},
	...
	"codex.term_status_title": {"zh": "状态牌（Status）", "en": "Status Cards"},
	...
	"codex.term_multihit_title": {"zh": "连击（Multi-hit）", "en": "Multi-hit"},
	...
	"codex.term_energy_body": {"zh": "每回合打牌都要花能量。所有角色默认基础能量都是 3；能天使不再天生高能量，而是通过准备 Burst，在下一回合获得 +2 能量和 +2 抽牌来打出连射高潮。如果带着 `Reserve Battery`，第一回合会额外 +1 能量。", "en": "Playing cards costs Energy. All characters now start each turn with 3 base Energy. Exusiai no longer has innate extra Energy; instead, preparing Burst grants +2 Energy and +2 draw on the next turn for her firing window. `Reserve Battery` adds +1 Energy on turn one."},
	...
	"codex.term_burst_body": {"zh": "爆发回合是能天使的下一回合强化连射窗口。打出 Burst 牌时不会当场爆发，而是获得“备”：下个玩家回合开始进入 Burst，能量 +2、抽牌 +2。进入 Burst 后，Shot +1 伤害；第 2 张 Shot 抽 1，第 3 张 Shot 返还 1 Ammo 并追加 3 点伤害。它不是常驻增益，而是先铺 Ammo / Mark / Reload，再用下一回合 Burst 一口气清场或点杀。", "en": "Burst is Exusiai's next-turn empowered firing window. Playing a Burst card does not activate immediately; it gives Prepare, then at the start of your next player turn Burst activates with +2 Energy and +2 draw. During Burst, Shots gain +1 damage; the second Shot draws 1, and the third Shot refunds 1 Ammo and deals 3 extra damage."},
...
var exusiai_event_result_text := {
	...
	"部署图被还原了七成。下一场战斗你会带着更清晰的意图入场，开局获得 3 点意志。": "部署图被还原了七成。下一场战斗你会带着更清晰的火力节奏入场，开局获得 2 点 Ammo。",
