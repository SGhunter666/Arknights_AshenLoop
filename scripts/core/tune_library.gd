...
const EXUSIAI_TUNES: Dictionary = {
	"ex_burst_entry_mag": {
		"title": "爆发备弹",
		"short": "进入 Burst 时恢复 1 Ammo",
		"description": "每次进入 Burst 时，立刻恢复 1 Ammo，让爆发回合更容易接起连射。",
		"archetype": "burst_window",
		"accent": "#ffb07a",
	},
	"ex_support_shot_link": {
		"title": "火线接力",
		"short": "首张 Support 后下一张 Shot +2",
		"description": "每回合第一张 Support 结算后，下一张 Shot 额外造成 2 点伤害。",
		"archetype": "support_chain",
		"accent": "#7dd6ff",
	},
	"ex_mark_trace_draw": {
		"title": "锁点追迹",
		"short": "本回合首次施加 Mark 抽 1",
		"description": "每回合第一次施加 Mark 后抽 1，让标记链更容易持续。",
		"archetype": "mark_control",
		"accent": "#d99fff",
	},
	"ex_reload_guard_screen": {
		"title": "掩体补弹",
		"short": "恢复 Ammo 时获得 4 护盾",
		"description": "每次恢复 Ammo 时，立刻获得 4 点护盾，适合边补弹边站场。",
		"archetype": "reload_tempo",
		"accent": "#96e7ff",
	},
	"ex_marked_shot_discount": {
		"title": "锁定压缩",
		"short": "场上有 Mark 时首张 Shot -1 费",
		"description": "若场上任一敌人带有 Mark，本回合第一张 Shot 费用 -1。",
		"archetype": "mark_control",
		"accent": "#ff8eab",
	},
	"ex_first_refill_draw": {
		"title": "补弹火花",
		"short": "本战首次恢复 Ammo 抽 1 并 +1 Ammo",
		"description": "每场战斗第一次恢复 Ammo 时，额外抽 1，并再恢复 1 Ammo。",
		"archetype": "reload_tempo",
		"accent": "#ffd07d",
	},
}
...
const DEFAULT_REWIRES: Dictionary = {
	"rewire_arts_bonus": {
		"title": "重构：每回合第一张 Arts +2 伤害",
		"description": "每回合第一张术式牌额外获得 +2 伤害，适合稳定补输出。",
		"done": "已选择临时战术：每回合第一张 Arts +2 伤害。",
		"shop_title": "重构：术式增幅",
	...
	"rewire_support_draw": {
		"title": "重构：每战第一次 Support 抽 2",
		"description": "每场战斗第一次打出支援牌时，额外抽 2 张牌。",
		"done": "已选择临时战术：每战第一次 Support 抽 2。",
		"shop_title": "重构：支援抽牌",
	...
	"rewire_overload_minus_one": {
		"title": "重构：Overload 结算伤害 -1",
		"description": "过载结算时受到的伤害减少 1 点，适合高压透支流。",
		"done": "已选择临时战术：Overload 结算伤害 -1。",
		"shop_title": "重构：过载缓冲",
...
const EXUSIAI_REWIRES: Dictionary = {
	"ex_rewire_first_shot_bonus": {
		"title": "重构：每回合第一张 Shot +2 伤害",
		"description": "每回合第一张 Shot 额外造成 2 点伤害，适合稳定开火。",
		"done": "已选择临时战术：每回合第一张 Shot +2 伤害。",
		"shop_title": "重构：首轮点射",
		"shop_desc": "每回合第一张 Shot 额外造成 2 点伤害，适合稳定开火。",
		"shop_done": "已接入重构：每回合第一张 Shot +2。",
		"accent": "#ffb26f",
	},
	"ex_rewire_reload_draw": {
		"title": "重构：每战首次补弹抽 2",
		"description": "每场战斗第一次恢复 Ammo 时，额外抽 2 张牌，让装填回合不断档。",
		"done": "已选择临时战术：每战首次补弹抽 2。",
		"shop_title": "重构：装填节拍",
		"shop_desc": "每场战斗第一次恢复 Ammo 时，额外抽 2 张牌，让装填回合不断档。",
		"shop_done": "已接入重构：每战首次补弹抽 2。",
		"accent": "#8fe6ff",
	},
	"ex_rewire_burst_ammo": {
		"title": "重构：Burst 中首张 Shot 返还 1 Ammo",
		"description": "每回合第一次在 Burst 状态下打出 Shot 时，返还 1 Ammo。",
		"done": "已选择临时战术：Burst 中首张 Shot 返还 1 Ammo。",
		"shop_title": "重构：爆发补仓",
		"shop_desc": "每回合第一次在 Burst 状态下打出 Shot 时，返还 1 Ammo。",
		"shop_done": "已接入重构：Burst 中首张 Shot 返还 1 Ammo。",
		"accent": "#ff8f8f",
	},
}
