...
func _apply_text(_language_code: String = "") -> void:
	title_label.text = LocalizationManager.text("victory.title")
	body_label.text = LocalizationManager.text("victory.body")
	...
	hint_label.text = LocalizationManager.text("victory.hint")
